...
# STUDENT_SYS_PROMPT_SHORT = "You are simulating a real student solving a math problem in a dialogue with a tutor."

TUTOR_SYS_PROMPT_SHORT = "You are a tutor guiding a student through a math problem."

STUDENT_SYS_PROMPT_SHORT_PROFILE = "You are simulating a real student attempting to solve a math problem, seeking help from a tutor. A profile of your personality traits and behavioral tendencies has been provided, your goal is to simulate realistic student behavior and your behavior in the current dialogue should be consistent with the provided profile."

STUDENT_SYS_PROMPT_SHORT_DIALOGUE = "You are simulating a real student attempting to solve a math problem, seeking help from a tutor. An previous dialogue between you and the tutor has been provided, your goal is to simulate realistic student behavior and your behavior in the current dialogue should be consistent with the provided dialogue."
...
def format_question(dialogue: Dialogue, kcs_src: str = None):
    ...
    if kcs_src == "eedi":
        ...
        question += "\n".join([f"- {kc}" for kc in dialogue["KC"]] + ["- Default"])

    return question

def get_local_prompt(dialogue: Dialogue, role: str, tokenizer: PreTrainedTokenizer, kcs_src: str = None, ending_turn: int = None, last_turn_sub: str = None, persona_type: str = None, input_type: str = None):
    ...
    if input_type == 'none':
        ...
        system_prompt = STUDENT_SYS_PROMPT_SHORT_PROFILE if input_type == 'profile' else STUDENT_SYS_PROMPT_SHORT_DIALOGUE
